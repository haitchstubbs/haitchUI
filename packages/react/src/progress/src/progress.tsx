...
type RootProps = Omit<React.HTMLAttributes<HTMLDivElement>, "children"> &
  RootOwnProps & {
    children?: React.ReactNode
  }

const Root = React.forwardRef<HTMLDivElement, RootProps>(function ProgressRoot(
  {
    value: valueProp,
    defaultValue,
    min: minProp = 0,
...
type IndicatorProps = React.HTMLAttributes<HTMLDivElement> & IndicatorOwnProps

const Indicator = React.forwardRef<HTMLDivElement, IndicatorProps>(function ProgressIndicator(
...
const Track = React.forwardRef<HTMLDivElement, TrackProps>(function ProgressTrack(props, ref) {
