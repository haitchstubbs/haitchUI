...
import { Slot } from "@/primitives/slot/index"
...
export const TabTrigger = React.forwardRef<HTMLButtonElement, TabsTriggerProps>(function TabsTrigger(
...
export const TabContent = React.forwardRef<HTMLDivElement, TabsPanelProps>(function TabsPanel(
