...
import { css } from "./src/stringToCSS";
...
export type ToasterProps = {
	...
	offset?: ToastOffset; // default 32px
	mobileToastOffset?: ToastOffset; // default 16px
...
const normalizeToastOffset = (
	o: ToastOffset | undefined,
	fallback: number
): Required<{
	top: string;
	right: string;
...
export function Toaster({
	...
	mobileToastOffset = DEFAULT_OFFSET_MOBILE,
	swipeDirections,
	dir = "ltr",
	hotkey = "alt+T",
	invert = false,
	...
	const effectiveToastOffset = React.useMemo(() => {
		return normalizeToastOffset(isMobile ? mobileToastOffset : offset, isMobile ? DEFAULT_OFFSET_MOBILE : DEFAULT_OFFSET_DESKTOP);
	}, [isMobile, offset, mobileToastOffset]);
			...
			style={
				{
					...
					["--ht-top" as any]: effectiveToastOffset.top,
					["--ht-right" as any]: effectiveToastOffset.right,
					["--ht-bottom" as any]: effectiveToastOffset.bottom,
					["--ht-left" as any]: effectiveToastOffset.left,
