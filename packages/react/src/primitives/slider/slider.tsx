...
export type SliderRootProps = Omit<React.HTMLAttributes<HTMLDivElement>, "defaultValue" | "onChange"> &
  RootOwnProps & {
...
export type SliderTrackProps = React.HTMLAttributes<HTMLDivElement> & { children?: React.ReactNode }

const SliderTrack = React.forwardRef<HTMLDivElement, SliderTrackProps>(function SliderTrack(
  { children, ...props },
  ref
) {
...
const SliderRange = React.forwardRef<HTMLDivElement, SliderRangeProps>(function SliderRange(props, ref) {
...
const SliderThumb = React.forwardRef<HTMLDivElement, SliderThumbProps>(function SliderThumb(props, ref) {
...
export const Slider = { SliderRoot, SliderTrack, SliderRange, SliderThumb }
