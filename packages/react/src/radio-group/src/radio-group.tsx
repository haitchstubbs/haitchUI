...
const Root = React.forwardRef<HTMLDivElement, RootProps>(function RadioGroupRoot(
  {
    value: valueProp,
    defaultValue,
    onValueChange,
...
const Item = React.forwardRef<HTMLButtonElement, ItemProps>(function RadioGroupItem(
  ...
  return (
    <ItemContext.Provider value={{ checked, disabled }}>
      <button
...
const Indicator = React.forwardRef<HTMLSpanElement, IndicatorProps>(function RadioGroupIndicator(
