...
export function Primary({ code, highlightedHtml }: { code: string; highlightedHtml: string }) {
  ...
  return (
    <>
      <CodeBlock 
        ...
        className=" border border-border rounded-lg overflow-clip max-w-md"
      >
        <CodeBlockHeader>
          <IconBrandTypescript className="w-4 h-4 text-muted-foreground" />
          <CodeBlockHeaderText>
            <CodeBlockTitle>Expandable Code Block</CodeBlockTitle>
          </CodeBlockHeaderText>
