...
import { IconChevronDown, IconDots, IconInfoCircleFilled, IconRosetteDiscountCheck } from "@tabler/icons-react";
...
export default function Home() {
	...
	return (
		<section className="bg-background flex w-full items-center justify-center p-8 gap-6 overflow-y-auto flex-col">
			{/* <DemoMode /> */}
				...
				<ItemActions>
					<DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen}>
						<DropdownMenuTrigger asChild>
							<Button
								variant="outline"
								className={cn(dropdownOpen ? "bg-accent text-accent-foreground" : "", "transition-colors duration-75 ease-in-out")}
							>
