...
function Accordion({
  ...props
}: React.ComponentProps<typeof AccordionPrimitive.AccordionRoot>) {
  return <AccordionPrimitive.AccordionRoot data-slot="accordion" {...props} />
}
...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.AccordionHeader className="flex">
