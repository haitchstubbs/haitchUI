...
function AlertDialog({
  ...
  return <AlertDialogPrimitive.AlertDialogRoot data-slot="alert-dialog" {...props} />
}
...
function AlertDialogTrigger({
  ...
  return (
    <AlertDialogPrimitive.AlertDialogTrigger data-slot="alert-dialog-trigger" {...props} />
  )
}
...
function AlertDialogPortal({
  ...
  return (
    <AlertDialogPrimitive.AlertDialogPortal data-slot="alert-dialog-portal" {...props} />
  )
}
