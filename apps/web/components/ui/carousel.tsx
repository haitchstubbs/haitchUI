...
import * as CarouselPrimitive from "@haitch-ui/react/carousel";
import { type CarouselApi, type UseCarouselEngineOptions } from "@haitch-ui/react/carousel";
...
function CarouselContent({ className, ...props }: React.ComponentProps<"div">) {
	...
	return (
		<CarouselPrimitive.CarouselViewport
			...
			className={cn("overflow-hidden", orientation === "horizontal" ? "touch-pan-y select-none" : "touch-pan-x select-none")}
			data-slot="carousel-content"
		>
			<CarouselPrimitive.CarouselContent className={cn("flex", orientation === "horizontal" ? "" : "-mt-4 flex-col", className)} {...props} />
		</CarouselPrimitive.CarouselViewport>
	);
}
